    ...
    public partial class SensorBox : UserControl
    {
        ...
        private void comboBox1_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            switch (comboItem)
            {
                ...
                case "1136 - Differential Gas Pressure Sensor ±2 kPa": sensorDisplay = new Sensor1136(); break;
                ...
                case "1140 - Absolute Gas Pressure Sensor 20-400 kPa": sensorDisplay = new Sensor1140(); break;
                case "1141 - Absolute Gas Pressure Sensor 15-115 kPa": sensorDisplay = new Sensor1141(); break;
                case "1142 - Light Sensor 1000 lux": sensorDisplay = new Sensor1142(); break;
                case "1143 - Light Sensor 70,000 lux": sensorDisplay = new Sensor1143(); break;
                case "1146 - IR Reflective Sensor 4mm": sensorDisplay = new Sensor1146(); break;
                ...
                case "3507-3510 - CE Voltage Sensor": sensorDisplay = new Sensor3507(); break;
                case "3511-3513 - CE Current Sensor": sensorDisplay = new Sensor3511(); break;
                case "3514-3519 - CE Active Power Sensor": sensorDisplay = new Sensor3514(); break;
                case "3584-3589 - CE Current Transducer": sensorDisplay = new Sensor3584(); break;
            }
        ...
        public void ChangeValue(int val)
        {
            ...
            switch (comboItem)
            {
                ...
                case "1136 - Differential Gas Pressure Sensor ±2 kPa": ((Sensor1136)sensorDisplay).changeDisplay(val); break;
                case "1137 - Differential Gas Pressure Sensor ±7 kPa": ((Sensor1137)sensorDisplay).changeDisplay(val); break;
                case "1138 - Differential Gas Pressure Sensor 50 kPa": ((Sensor1138)sensorDisplay).changeDisplay(val); break;
                case "1139 - Differential Gas Pressure Sensor 100 kPa": ((Sensor1139)sensorDisplay).changeDisplay(val); break;
                case "1140 - Absolute Gas Pressure Sensor 20-400 kPa": ((Sensor1140)sensorDisplay).changeDisplay(val); break;
                case "1141 - Absolute Gas Pressure Sensor 15-115 kPa": ((Sensor1141)sensorDisplay).changeDisplay(val); break;
                case "1142 - Light Sensor 1000 lux": ((Sensor1142)sensorDisplay).changeDisplay(val); break;
                case "1143 - Light Sensor 70,000 lux": ((Sensor1143)sensorDisplay).changeDisplay(val); break;
                case "1146 - IR Reflective Sensor 4mm": ((Sensor1146)sensorDisplay).changeDisplay(val); break;
                ...
                case "3507-3510 - CE Voltage Sensor": ((Sensor3507)sensorDisplay).changeDisplay(val); break;
                case "3511-3513 - CE Current Sensor": ((Sensor3511)sensorDisplay).changeDisplay(val); break;
                case "3514-3519 - CE Active Power Sensor": ((Sensor3514)sensorDisplay).changeDisplay(val); break;
                case "3584-3589 - CE Current Transducer": ((Sensor3584)sensorDisplay).changeDisplay(val); break;
            }
        }
